...
export const gearItems: GearItem[] = [
  ...
  item("Sunfire fanatic cuirass",  'body',          'varlamore'),
  item("Sunfire fanatic chausses", 'legs',          'varlamore'),
  item("Dragon hunter wand",       'magic-weapon',  'varlamore'),
  item("Hueycoatl hide coif",      'head',          'varlamore'),
  item("Hueycoatl hide body",      'body',          'varlamore'),
  ...
  item("Oathplate helm",           'head',         'zeah'),
  item("Oathplate body",           'body',         'zeah'),
  item("Oathplate legs",           'legs',         'zeah'),
  item("Radiant oathplate helm",   'head',         'zeah'),
  item("Radiant oathplate body",   'body',         'zeah'),
  item("Radiant oathplate legs",   'legs',         'zeah'),
  item("Dragon claws",             'spec-weapon',  'zeah'),
  ...
  item("Ava's accumulator",        'cape',          'fremennik'),
  item("Leaf-bladed battleaxe",    'melee-weapon',  'fremennik'),
  item("Dragonbone necklace",      'neck',          'fremennik'),
  ...
  item("Zaryte vambraces",         'hands',         'asgarnia'),
  item("Zaryte crossbow",          'spec-weapon',   'asgarnia'),
  ...
  item("Dark bow",                'ranged-weapon','tirannwn'),
  ...
  item("Light ballista",           'ranged-weapon', 'kandarin'),
  item("Trident of the seas",     'magic-weapon',  'kandarin'),
  item("Abyssal tentacle",        'melee-weapon',  'kandarin'),
  ...
  item("Black mask",               'head',         'morytania'),
  item("Rune boots",               'feet',         'morytania'),
  item("Amulet of blood fury",     'neck',         'morytania'),
  item("Barrelchest anchor",       'melee-weapon', 'morytania'),
  item("Nightmare staff",          'magic-weapon', 'morytania'),
  item("Eldritch nightmare staff", 'magic-weapon', 'morytania'),
  item("Harmonised nightmare staff",'magic-weapon','morytania'),
  item("Volatile nightmare staff", 'magic-weapon', 'morytania'),
  item("Granite boots",            'feet',         'morytania'),
  // Barrows — Ahrim
  ...
  item("Infinity hat",             'head',          'desert'),
  item("Infinity top",             'body',          'desert'),
  item("Infinity bottoms",         'legs',          'desert'),
  item("Master wand",              'magic-weapon',  'desert'),
  item("Osmumten's fang",          'melee-weapon',  'desert'),
  item("Ancient staff",            'magic-weapon',  'desert'),
  item("Ring of shadows",          'ring',          'desert'),
  item("Mage's book",              'shield',        'desert'),
  item("Tome of water",            'shield',        'desert'),
  ...
  item("Abyssal whip",             'melee-weapon', 'global'),
